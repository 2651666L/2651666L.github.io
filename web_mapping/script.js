...
const map = new mapboxgl.Map({
  ...
  style: "mapbox://styles/c040120mb/ckzr2dj7z001v15pgysv3ra3y",
...
/* 
Below we are defining 2 events:1) when user click the marker 2) create the cluserted marker
*/
...
map.on("click", (event) => {
  ...
  const features = map.queryRenderedFeatures(event.point, {
    layers: ["charging-station"] // replace with your layer name
  });
  ...
  map.flyTo({
    ...
    zoom: 12 //change fly to zoom level
  });
...
/* 
Add an event listener that runs
  when the map is being loaded.
  Below shows the code to make cluserted markers.
  The code was borrowed from https://docs.mapbox.com/mapbox-gl-js/example/cluster/
*/
...
map.on("load", () => {
  ...
  map.addSource("sites", {
    ...
    data:
      "https://api.mapbox.com/datasets/v1/c040120mb/ckzr1tnye0mh821r0ww5n6h40/features/?access_token=pk.eyJ1IjoiYzA0MDEyMG1iIiwiYSI6ImNreWtpYWZ4ZTJ3ZjkydnA4YTFkcXVxb3oifQ.Jk2yP5Db0fcp5cHKNuS7OQ",
  ...
  map.addLayer({
    ...
    source: "sites", //match the source name to the data source you added above
